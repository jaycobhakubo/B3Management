...
{
    public partial class GameSettingTimeBomb : SettingsControl
    {
        private readonly _cs_Other.GameSettings m_gameSettings;

        public GameSettingTimeBomb()
        {
            InitializeComponent();
        ...
        private bool SaveTimeBombGameSettings()
        {
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Call Speed", m_gameSettings.MaxPatternsBonus.ToString(), numCallSpeed.Value.ToString(CultureInfo.InvariantCulture));
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 1 cent", m_gameSettings.Denom1, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 5 cent", m_gameSettings.Denom5, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 10 cent", m_gameSettings.Denom10, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 25 cent", m_gameSettings.Denom25, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 50 cent", m_gameSettings.Denom50, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 1 dollar", m_gameSettings.Denom100, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 2 dollars", m_gameSettings.Denom200, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Denom 5 dollars", m_gameSettings.Denom500, isTrue);
            ...
            {
                WriteLog.WriteLogUpdate("", CurrentUserLoggedIn.username, "UPDATE", GetCurrentMacID.MacAddress, "Time Bomb Setting - Hide card serial number", m_gameSettings.HideCardSerialNumber, isTrue);
                m_gameSettings.HideCardSerialNumber = isTrue;
            }

            SetGameSettingsTimeBomb.SetSettings(m_gameSettings);
