...
namespace GameTech.B3Reports
{
    class GetGameSettingJailbreak
    {
        ...
        public static int callspeed = 500;
        ...
        public int CallSpeed
        {
            get { return callspeed; }
            set { callspeed = value; }
        }
        ...
        public GetGameSettingJailbreak()
        {
            ...
            {
                sc.Open();
                using (SqlCommand cmd = new SqlCommand(@"exec usp_GameSettings_JailBreak_Get", sc))
                {
                    ...
                    while (reader.Read())
                    {
                              ...
                              callspeed = reader.GetInt32(6);
                              autocall = reader.GetString(7);
                              autoplay = reader.GetString(8);
                              denom_1 = reader.GetString(9);
                              denom_5 = reader.GetString(10);
                              denom_10 = reader.GetString(11);
                              denom_25 = reader.GetString(12);
                              denom_50 = reader.GetString(13);
