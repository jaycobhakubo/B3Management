...
namespace GameTech.B3Reports.Reports {
    ...
    public class BallCall_byGame : ReportClass {
        
        public BallCall_byGame() {
        }
        
        public override string ResourceName {
            get {
                return "BallCall_byGame.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "GameTech.B3Reports.Reports.BallCall_byGame.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBallCall_byGame : Component, ICachedReport {
        
        public CachedBallCall_byGame() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BallCall_byGame rpt = new BallCall_byGame();
            rpt.Site = this.Site;
            return rpt;
        }
